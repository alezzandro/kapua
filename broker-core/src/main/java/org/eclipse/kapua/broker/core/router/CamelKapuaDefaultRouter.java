...
import org.eclipse.kapua.broker.core.plugin.BrokerJAXBContextProvider;
...
public class CamelKapuaDefaultRouter {
    ...
    public CamelKapuaDefaultRouter() {
        ...
        logger.info("Default Camel routing... Loading configuration from file {} DONE", configurationFileName);
    }
